import pulumi
from pulumi_azure_native import resources, network, compute, storage, web, containerservice, dbforpostgresql, cosmosdb, sql
...
#             key_data="AAAAB3NzaC1yc2EAAAADAQABAAACAQC",  # Replace with your actual public key
#         )],
#     ),
# ),
...
#export("postgresql_server_fqdn", postgresql_server.fully_qualified_domain_name)