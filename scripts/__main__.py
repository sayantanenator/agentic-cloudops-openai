...
resource_group = resources.ResourceGroup(
    "resourcegroup-prod-aumanager-eastus",
    location=location,
    tags=tags
)
...
vnet = network.VirtualNetwork(
    "virtualnetwork-prod-aumanager-eastus",
...
subnet1 = network.Subnet(
    "subnet-prod-aumanager-eastus-1",
    resource_group_name=resource_group.name,
...
subnet2 = network.Subnet(
    "subnet-prod-aumanager-eastus-2",
    resource_group_name=resource_group.name,
    virtual_network_name=vnet.name,
...
public_ip = network.PublicIPAddress(
    "publicip-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
load_balancer = network.LoadBalancer(
    "loadbalancer-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
storage_account = storage.StorageAccount(
    "storageaccount-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
    sku=storage.SkuArgs(
...
blob_container = storage.BlobContainer(
    "blobcontainer-prod-aumanager-eastus",
...
file_share = storage.FileShare(
    "fileshare-prod-aumanager-eastus",
    account_name=storage_account.name,
    resource_group_name=resource_group.name,
    share_name="files"
)
...
data_lake_storage = storage.StorageAccount(
    "datalakestorage-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
    sku=storage.SkuArgs(
        name=storage.SkuName.STANDARD_LRS,
...
vm = compute.VirtualMachine(
    "virtualmachine-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
    ...
    network_profile=compute.NetworkProfileArgs(
        network_interfaces=[compute.NetworkInterfaceReferenceArgs(
            id=network.NetworkInterface(
                "networkinterface-prod-aumanager-eastus",
                resource_group_name=resource_group.name,
                location=location,
...
app_service_plan = web.AppServicePlan(
    "appserviceplan-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
    kind="Linux",
...
app_service = web.WebApp(
    "appservice-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
storage_account_function = storage.StorageAccount(
    "functionstorage-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
function_app = web.WebApp(
    "functionapp-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
    server_farm_id=app_service_plan.id,
    kind="functionapp",
...
sql_server = sql.Server(
    "sqlserver-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
sql_database = sql.Database(
    "sqldatabase-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
cosmos_account = cosmosdb.DatabaseAccount(
    "cosmosaccount-prod-aumanager-eastus",
    resource_group_name=resource_group.name,
    location=location,
...
cosmos_db = cosmosdb.SqlResourceSqlDatabase(
    "cosmosdb-prod-aumanager-eastus",
